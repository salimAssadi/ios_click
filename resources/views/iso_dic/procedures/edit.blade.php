                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 mt-3">
                            ...
                            <small
                                class="text-muted">{{ __('Supported formats: PDF, DOC, DOCX, XLS, XLSX. Max size: 10MB') }}</small>
                            @error('attachments.*')
                        ...
                        <div class="form-group col-md-12">
                            <div class="form-check form-check-inline">
                                {!! Form::checkbox('enable_upload_file', 1, $procedure->enable_upload_file, [
                                    'class' => 'form-check-input',
                                    'id' => 'enable_upload_file',
                                ]) !!}
                                {!! Form::label('enable_upload_file', __('Enable Upload File'), ['class' => 'form-check-label']) !!}
                            </div>

                            <div class="form-check form-check-inline">
                                {!! Form::checkbox('enable_editor', 1, $procedure->enable_editor, [
                                    'class' => 'form-check-input',
                                    'id' => 'enable_editor',
                                ]) !!}
                            ...
                            {!! Form::checkbox('has_menual_config_display', 1, $procedure->has_menual_config, [
                                'class' => 'form-check-input',
                                'id' => 'has_menual_config_display',
                                'disabled' => true,
                            ]) !!}

                            {!! Form::label('has_menual_config_display', __('Has Manual Config'), ['class' => 'form-check-label me-1']) !!}

                            <i class="ti ti-info-circle text-muted " style="cursor: pointer;" data-bs-toggle="tooltip"
                                data-bs-placement="left"
                                title="{{ __('This option is disabled in Main or Public procedure.') }}"></i>

                            {!! Form::hidden('has_menual_config', $procedure->has_menual_config) !!}
                        </div>
                    </div>
