        ...
        <div class="col-sm-12">
                                ...
                                <div class="card-body ">
                                    <div class="row mb-none-30">
                                        <div class="col-lg-12">
                                            ...
                                            <p class="text-danger">
                                                *{{ __('Please ensure that you include all the variables related to the procedure in the template. These variables are essential to ensure the procedure works correctly, as they will be used to customize and execute the required process.') }}
                                            </p>
                                            <div class="card-body">
            ...
            <div class="card">
                <div class="card-body pt-0">
                    <form method="POST" action="{{ route('iso_dic.procedures.saveTemplatePath', $procedure->id) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <p class="pt-3 text-danger">
                                *{{ __('Please provide the template that the system will process to create the required operations or procedures.') }}
                            </p>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="template_path" id="file_path" class="form-control"
                                        ...
                                        value="@if (isset($procedure->template_path)) {{ $procedure->template_path }} @endif"
                                        readonly>
