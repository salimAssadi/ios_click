                    ...
                    <div class="row align-items-center g-2">
                        ...
                        <div class="col-auto">
                            <a class="btn btn-secondary customModal" href="#" data-size="md"
                                data-url="{{ route('iso_dic.document.create') }}" data-title="{{ __('Create Document') }}">
                                        ...
                                        <td class="text-right">
                                            <div class="cart-action">
                                                ...
                                                <a class="avtar avtar-xs btn-link-warning text-warning"
                                                    ...
                                                    href="{{ route('iso_dic.document.show', \Illuminate\Support\Facades\Crypt::encrypt($document->id)) }}">
                                                    <i data-feather="eye"></i></a>

                                                <a class="avtar avtar-xs btn-link-secondary text-secondary customModal"
                                                    data-bs-toggle="tooltip" data-bs-original-title="{{ __('Edit') }}"
                                                    href="#"
                                                    data-url="{{ route('iso_dic.document.edit', $document->id) }}"
