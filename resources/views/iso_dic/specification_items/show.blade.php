...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('iso_systems.index') }}">{{ __('Customer') }}</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    ...
                                                    @foreach ($subscriptions as $subscription_key => $subscription)
                                                        ...
                                                        <ul class="gap-2 mt-3 plan_change_info customCheckdef{{ $subscription_key }}" style="display:{{ $subscription->id == $user->subscription ? 'block' : 'none' }}">
