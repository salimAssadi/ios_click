        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('Edit Sample') }}</h5>
                </div>
                <div class="card-body">
                    {{ Form::model($sample, ['route' => ['iso_dic.samples.update', $sample->id], 'method' => 'PUT', 'files' => true]) }}
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    {{ Form::radio('is_optional', 1, null, ['class' => 'form-check-input', 'id' => 'is_optional']) }}
                                    {{ Form::label('Optional', __('Optional'), ['class' => 'form-check-label']) }}
                                </div>
                                <div class="form-check form-check-inline">
                                    {{ Form::radio('is_optional', 0, null, ['class' => 'form-check-input', 'id' => 'required']) }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    {{ Form::radio('status', 1, null, ['class' => 'form-check-input', 'id' => 'status_active']) }}
                                    {{ Form::label('status_active', __('Active'), ['class' => 'form-check-label']) }}
                                </div>
                                <div class="form-check form-check-inline">
                                    {{ Form::radio('status', 0, null, ['class' => 'form-check-input', 'id' => 'status_inactive']) }}
