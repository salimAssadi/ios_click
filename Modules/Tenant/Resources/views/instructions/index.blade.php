        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center g-3">
                    <div class="col">
                        <h4 class="mb-0">{{ __('Instructions') }}</h4>
                    </div>
                    <div class="col-auto">
                        <a href="{{ route('iso_dic.instructions.create') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <h6 class="mb-0">{{ app()->getLocale() == 'ar' ? $instruction->name_ar : $instruction->name_en }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-wrap gap-1">
                                            @foreach($instruction->procedures as $procedure)
                                    ...
                                    <td>
                                        @if($instruction->attachments->count() > 0)
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end gap-2">
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['iso_dic.instructions.destroy', $instruction->id], 'class' => 'd-inline']) !!}
                                            
                                            <a href="{{ route('iso_dic.instructions.edit', $instruction->id) }}"
                                            ...
                                            <a href="{{ route('iso_dic.instructions.show', $instruction->id) }}"
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <p class="text-body-secondary mb-0">{{ __('No instructions found') }}</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
